...
window.addEventListener('DOMContentLoaded', (event) => {
    ...
    let pomaosprites = new Image()
    pomaosprites.src = 'rotating pomao sheet.png'
...
//         console.log(gamepadAPI.axesStatus[1]*gamepadAPI.axesStatus[0]) //debugging
    ...
    class Party{
        constructor(){
            this.body = new Circle(350,350, 32)
            this.xdir = 0
            this.ydir = 0
        }
        move(){
        ...
        draw(){
            ...
            if(this.xdir == 1){
                if(this.ydir == 1){
                    canvas_context.drawImage(pomaosprites, 64,0, 64, 64, this.body.x-32, this.body.y-32, 64,64)
                }else if(this.ydir == -1){
                    canvas_context.drawImage(pomaosprites, 7*64,0, 64, 64, this.body.x-32, this.body.y-32, 64,64)
                }else{
                    canvas_context.drawImage(pomaosprites, 0,0, 64, 64, this.body.x-32, this.body.y-32, 64,64)
                }
            }else if(this.xdir == -1){
                if(this.ydir == 1){
                    canvas_context.drawImage(pomaosprites, 3*64,0, 64, 64, this.body.x-32, this.body.y-32, 64,64)
                }else if(this.ydir == -1){
                    canvas_context.drawImage(pomaosprites, 5*64,0, 64, 64, this.body.x-32, this.body.y-32, 64,64)
                }else{
                    canvas_context.drawImage(pomaosprites, 4*64,0, 64, 64, this.body.x-32, this.body.y-32, 64,64)
                }
            }else{
                if(this.ydir == 1){
                    canvas_context.drawImage(pomaosprites, 128,0, 64, 64, this.body.x-32, this.body.y-32, 64,64)
                }else if(this.ydir == -1){
                    canvas_context.drawImage(pomaosprites, 6*64,0, 64, 64, this.body.x-32, this.body.y-32, 64,64)
                }else{
                    canvas_context.drawImage(pomaosprites, 0,0, 64, 64, this.body.x-32, this.body.y-32, 64,64)
                }
            }
